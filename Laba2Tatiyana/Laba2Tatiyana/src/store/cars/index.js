...
export default {
  ...
  actions: {
    ...
    addItem: async ({ commit }, { name, surname, patronymic, buyer }) => {
      const item = await api.add({ name, surname, patronymic, buyer })
      commit('setItem', item)
    },
    updateItem: async ({ commit }, { id, name, surname, patronymic, buyer }) => {
      const item = await api.update({ id, name, surname, patronymic, buyer });
