<template>
  <div :class="$style.root">
    <Table
        :headers="[
          {value: 'id', text: 'ID'},
          {value: 'buyer', text: 'Машина'},
          {value: 'description', text: 'Впечатление о покупке'},
...
import { selectItems, removeItem, fetchItems  } from '@/store/buyers/selectors'
